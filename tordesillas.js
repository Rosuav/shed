...
const {A, BR, DIV, P, UL} = choc; //autoimport
...
set_content("#map", [
	...
	DIV([
		"Legend:",
		UL(), //TODO: List the colours and their name signatures
		P([
			"City data sourced from", BR(), A({href: "https://simplemaps.com/data/world-cities"}, "Simple Maps"),
		]),
	]),
]);
