...
GAMES = 3000
PLAYERS_PER_GAME = 3
BYTES_PER_MOVE = 1 # Client to server
BYTES_PER_UPDATE = 1 # Server to client
...
async def establish_clients(hosts):
	...
	tm = time.time()
	print("%8s %8s %6s" % ("Moves/s", "KBytes/s", "Socks"))
	while True:
		await asyncio.sleep(10)
		t = time.time(); delay = t - tm; tm = t
		print("%8.2f %8.2f %6d" % (stats[1]/delay, stats[2]/delay/1024, stats[0]))
		stats[1:] = 0, 0
